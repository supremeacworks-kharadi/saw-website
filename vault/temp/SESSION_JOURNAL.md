...
Router (http://localhost:3000/node_modules/.vite/deps/react-router-dom.js?v=43e6b482:7511:13)
...
## 2026-09-23 14:46:35.243Z load
- url: http://localhost:3000/shop
- title: Supreme AC Works — AC Spare Parts, Refrigerants & HVAC Materials

## 2026-09-23 14:46:35.375Z load
- url: http://localhost:3000/
- title: Supreme AC Works — AC Spare Parts, Refrigerants & HVAC Materials

## 2026-09-23 14:46:35.376Z load
- url: http://localhost:3000/shop
- title: Supreme AC Works — AC Spare Parts, Refrigerants & HVAC Materials

## 2026-09-23 14:46:36.947Z console.error
- text: 
    Warning: React does not recognize the `%s` prop on a DOM element. If you intentionally want it to appear in the DOM as a custom attribute, spell it as lowercase `%s` instead. If you accidentally passed it from a parent component, remove it from the DOM element.%s fetchPriority fetchpriority 
        at img
        at a
...
## 2026-09-23 14:46:36.912Z console.error
- text: 
    Warning: React does not recognize the `%s` prop on a DOM element. If you intentionally want it to appear in the DOM as a custom attribute, spell it as lowercase `%s` instead. If you accidentally passed it from a parent component, remove it from the DOM element.%s fetchPriority fetchpriority 
        at img
        at a
        ...
        at ProductCard (http://localhost:3000/src/components/site/ProductCard.jsx?t=1790172432819:24:3)
        at div
        at FeaturedProducts (http://localhost:3000/src/pages/builder/home/HomePage.jsx?t=1790172432819:44:35)
        at div
        at section
        at HomePage (http://localhost:3000/src/pages/builder/home/HomePage.jsx?t=1790172432819:101:20)
        at RenderedRoute (http://localhost:3000/node_modules/.vite/deps/react-router-dom.js?v=43e6b482:6647:26)
        at Routes (http://localhost:3000/node_modules/.vite/deps/react-router-dom.js?v=43e6b482:7572:3)
        at Suspense
        at ErrorBoundary (http://localhost:3000/src/components/ErrorBoundary.jsx:5:5)
...
## 2026-09-23 14:46:37.148Z console.error
- text: 
    Warning: React does not recognize the `%s` prop on a DOM element. If you intentionally want it to appear in the DOM as a custom attribute, spell it as lowercase `%s` instead. If you accidentally passed it from a parent component, remove it from the DOM element.%s fetchPriority fetchpriority 
        at img
        at a
...
## 2026-09-23 15:20:01.792Z load
- url: http://localhost:3000/shop
- title: Supreme AC Works — AC Spare Parts, Refrigerants & HVAC Materials

## 2026-09-23 15:20:01.849Z load
- url: http://localhost:3000/shop
- title: Supreme AC Works — AC Spare Parts, Refrigerants & HVAC Materials

## 2026-09-23 15:20:01.850Z load
- url: http://localhost:3000/
- title: Supreme AC Works — AC Spare Parts, Refrigerants & HVAC Materials

## 2026-09-23 15:20:01.847Z network.error
- method: GET
- url: https://api-ecommerce.hostinger.com/store/store_01M2TAZ71AKQRW8J22X1R66HR3/products?offset=0&limit=100&exclude_types=subscription
- message: Failed to fetch
- durationMs: 4

## 2026-09-23 15:20:01.847Z console.error
- text: 
    TypeError: Failed to fetch
        at window.fetch (http://localhost:3000/@id/virtual:session-journal-client:328:28)
        at window.fetch (http://localhost:3000/shop:605:23)
        at getProducts (http://localhost:3000/src/api/EcommerceApi.js:523:26)
...
## 2026-09-23 15:20:01.847Z console.warn
- text: 
    [useProducts] failed to load products TypeError: Failed to fetch
        at window.fetch (http://localhost:3000/@id/virtual:session-journal-client:328:28)
        at window.fetch (http://localhost:3000/shop:605:23)
        at getProducts (http://localhost:3000/src/api/EcommerceApi.js:523:26)
        at Module.getAllProducts (http://localhost:3000/src/api/EcommerceApi.js:592:27)
...
## 2026-09-23 15:20:02.385Z network.error
- method: GET
- url: https://api-ecommerce.hostinger.com/store/store_01M2TAZ71AKQRW8J22X1R66HR3/products?limit=8&exclude_types=subscription
- message: Failed to fetch
- durationMs: 51

## 2026-09-23 15:20:02.429Z console.error
- text: 
    TypeError: Failed to fetch
        at window.fetch (http://localhost:3000/@id/virtual:session-journal-client:328:28)
        at window.fetch (http://localhost:3000/:605:23)
        at Module.getProducts (http://localhost:3000/src/api/EcommerceApi.js:523:26)
        at http://localhost:3000/src/pages/builder/home/HomePage.jsx?t=1790172432819:51:34

## 2026-09-23 15:20:02.430Z console.warn
- text: 
    [HomePage] failed to load featured products TypeError: Failed to fetch
        at window.fetch (http://localhost:3000/@id/virtual:session-journal-client:328:28)
        at window.fetch (http://localhost:3000/:605:23)
        at Module.getProducts (http://localhost:3000/src/api/EcommerceApi.js:523:26)
        at http://localhost:3000/src/pages/builder/home/HomePage.jsx?t=1790172432819:51:34

## 2026-09-23 15:20:02.158Z network.error
- method: GET
- url: https://api-ecommerce.hostinger.com/store/store_01M2TAZ71AKQRW8J22X1R66HR3/products?offset=0&limit=100&exclude_types=subscription
- message: Failed to fetch
- durationMs: 20

## 2026-09-23 15:20:02.162Z console.error
- text: 
    TypeError: Failed to fetch
        at window.fetch (http://localhost:3000/@id/virtual:session-journal-client:328:28)
        at window.fetch (http://localhost:3000/shop:605:23)
...
## 2026-09-23 15:20:02.163Z console.warn
- text: 
    [useProducts] failed to load products TypeError: Failed to fetch
        at window.fetch (http://localhost:3000/@id/virtual:session-journal-client:328:28)
        at window.fetch (http://localhost:3000/shop:605:23)
